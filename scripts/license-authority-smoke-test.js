...
(async () => {
  try {
    ...
    assert.deepEqual(signedIn.taskTypes, { pokemoncenter: true, walmart: false, costco: false, round1: false });
    ...
    assert.deepEqual(refreshed.taskTypes, { pokemoncenter: false, walmart: false, costco: false, round1: true });
    assert.deepEqual(entitlementChanges, [{
      removed: ['pokemoncenter'],
      previous: { pokemoncenter: true, walmart: false, costco: false, round1: false },
      next: { pokemoncenter: false, walmart: false, costco: false, round1: true },
    }]);
