...
assert.match(groups, /copyWatchedSkus/);
assert.match(groups, /Copy All/);
assert.match(groups, /<textarea/);
assert.match(groups, /one per line/);
assert.match(groups, /skus\.join\('\\n'\)/);
