...
for launcher_file in \
  ...
  managed-proxy-ipc-guard.js resifactory-client.js resifactory-control.js evomi-client.js evomi-control.js ipfist-client.js ipfist-control.js hcaptcha-autosolver.js harvester-extension-bridge.js mobile-harvester-bridge.js companion-harvester-bridge.js harvest-room-demand.js cloud-backup.js cloud-backup-data.js runtime-manager.js; do
