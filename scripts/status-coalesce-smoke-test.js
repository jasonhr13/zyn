...
assert.match(engine, /function operatorLogsEnabled\(\)/);
assert.match(engine, /showOperatorLogs/);
assert.match(engine, /if \(!operatorLogsEnabled\(\)\) return;/);
assert.match(engine, /if \(!operatorLogsEnabled\(\)\) \{\s*dropPendingLogBufs\(logBufs\);/s);
assert.match(engine, /if \(!operatorLogsEnabled\(\)\) \{\s*dropPendingLogBufs\(pokemonLogBufs\);/s);
assert.match(engine, /if \(!operatorLogsEnabled\(\)\) \{\s*dropPendingLogBufs\(walmartLogBufs\);/s);
