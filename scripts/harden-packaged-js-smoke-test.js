...
assert.match(macBuild, /--no-bytecode/);
assert.match(winBuild, /--no-bytecode/);
assert.doesNotMatch(macBuild, /harden-packaged-js\.cjs" "\$TEMP_DIR\/app"/);
assert.doesNotMatch(winBuild, /harden-packaged-js\.cjs" "\$TEMP_DIR\/app"/);
